...
namespace HybridNetworkLib.Serializers.CobblestoneSerializer
{
    public class ByteReader
    {
        ...
        public string ReadString(bool peek = false)
        {
            ...
            _readIndex += peek ? 0 : ByteWriter.SizeOf(value) - ByteWriter.SizeOf(length);
            return value;
        }
